...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_help)
        {
            ...
            Integer[] imageData = {R.drawable.loading_page,R.drawable.loading_page,R.drawable.loading_page};
            ArrayList<Integer> imageArrayList = new ArrayList<Integer>();
            for(int i = 0; i< imageData.length; i++)
                imageArrayList.add(imageData[i]);
            bundle.putIntegerArrayList("list",imageArrayList);
            bundle.putInt("length",imageData.length);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAMERA_PIC_REQUEST && resultCode == RESULT_OK) {
            ...
            System.out.println("image data:" + extras);
