...
//            chosenFile = new File(filename);
              chosenFile = new File("/sdcard/DCIM/",filename);
...
//                client.post("http://images.google.com/searchbyimage?image_url="+link, new TextHttpResponseHandler() {
                client.get("http://140.118.110.209:3000/google?img="+link, new TextHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, String responseString) {
                        ...
                        if(responseString!=null) {
                            ...
                            responseString = java.net.URLEncoder.encode(responseString);
                            WebView.loadUrl("https://m.momoshop.com.tw/search.momo?searchKeyword=" + responseString +
